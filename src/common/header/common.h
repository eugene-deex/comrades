...
#define YQ2VERSION "7.43pre-CMR_0.1"
#define BASEDIRNAME "baseq2"

#define YQ2OSTYPE	"Windows"
#define YQ2ARCH	"x86"
...
// stuff to align variables/arrays
	...
	#define YQ2_ALIGNAS_TYPE(TYPE)  __declspec( align( 4 ) )	// FIXME
#else
...
#define YQ2_COM_CHECK_OOM(VAR, ALLOC_FN_NAME, ALLOC_SIZE) \
	if(VAR == NULL) { \
		Com_Error(ERR_FATAL, "%s for " YQ2_COM_PRIdS " bytes failed (%s == NULL)! Out of Memory?!\n", \
		                     ALLOC_FN_NAME, (size_t)ALLOC_SIZE, #VAR); }
