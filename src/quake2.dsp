...
"C:\Quake2\yquake2.exe" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy $(TargetDir)\yquake2.exe "C:\Quake2\yquake2.exe"
...
# ADD CPP /nologo /MLd /W3 /Gi /GX /ZI /Od /I "./client\refresh" /D "YQ2OSTYPE Windows" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /FAs /FR /FD /c
# SUBTRACT CPP /YX
# ADD BASE RSC /l 0x419 /d "NDEBUG"
# ADD RSC /l 0x419 /d "NDEBUG"
BSC32=bscmake.exe
