...
TargetDir=\q2src\temp\game\!release
InputPath=\q2src\temp\game\!release\game.dll
SOURCE="$(InputPath)"

"C:\Quake2\baseq2\game.dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy $(TargetDir)\game.dll "C:\Quake2\baseq2\game.dll"
...
# ADD CPP /nologo /MDd /W3 /Gm /Gi /GX /ZI /Od /I "./" /I "ents" /I "game" /I "global" /I "monsters" /I "../common" /I "../pm_shared" /D "YQ2OSTYPE Windows" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /FR /FD /c
# SUBTRACT CPP /u /YX
...
# Begin Custom Build - Performing Custom Build Step on $(InputPath)
TargetDir=\q2src\temp\game\!debug
InputPath=\q2src\temp\game\!debug\game.dll
SOURCE="$(InputPath)"
