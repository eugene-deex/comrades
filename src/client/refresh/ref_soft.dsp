...
# Begin Custom Build
TargetDir=\Quake2\src_main\temp\ref_soft\!release
InputPath=\Quake2\src_main\temp\ref_soft\!release\ref_soft.dll
SOURCE="$(InputPath)"

"D:\Quake2\ref_soft.dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy $(TargetDir)\ref_soft.dll "D:\Quake2\ref_soft.dll"
...
# Begin Custom Build
TargetDir=\Quake2\src_main\temp\ref_soft\!debug
InputPath=\Quake2\src_main\temp\ref_soft\!debug\ref_soft.dll
SOURCE="$(InputPath)"
