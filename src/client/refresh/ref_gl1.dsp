...
# Begin Custom Build
TargetDir=\q2src\temp\ref_gl1\!release
InputPath=\q2src\temp\ref_gl1\!release\ref_gl1.dll
SOURCE="$(InputPath)"

"C:\Quake2\ref_gl1.dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy $(TargetDir)\ref_gl1.dll "C:\Quake2\ref_gl1.dll"
...
# Begin Custom Build
TargetDir=\q2src\temp\ref_gl1\!debug
InputPath=\q2src\temp\ref_gl1\!debug\ref_gl1.dll
SOURCE="$(InputPath)"
