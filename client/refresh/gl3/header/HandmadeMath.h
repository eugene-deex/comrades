...
#include <stdio.h> // This is for types
...
#define HMM_INLINE static _inline
...
{
    hmm_mat4 Result = HMM_Mat4d(1.0f);
    float SinTheta, CosTheta, CosValue;
    
    Axis = HMM_NormalizeVec3(Axis);
    
    SinTheta = HMM_SinF(HMM_ToRadians(Angle));
    CosTheta = HMM_CosF(HMM_ToRadians(Angle));
    CosValue = 1.0f - CosTheta;
