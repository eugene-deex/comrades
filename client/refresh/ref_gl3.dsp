...
# Begin Custom Build
TargetDir=\Quake2\src_main\temp\ref_gl3\!release
InputPath=\Quake2\src_main\temp\ref_gl3\!release\ref_gl3.dll
SOURCE="$(InputPath)"

"D:\Quake2\ref_gl3.dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy $(TargetDir)\ref_gl3.dll "D:\Quake2\ref_gl3.dll"
...
# ADD CPP /nologo /MDd /W3 /Gm /Gi /GX /ZI /Od /I "./" /I "./gl3/glad/include" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /FR /FD /c
# SUBTRACT CPP /YX
...
# Begin Custom Build
TargetDir=\Quake2\src_main\temp\ref_gl3\!debug
InputPath=\Quake2\src_main\temp\ref_gl3\!debug\ref_gl3.dll
SOURCE="$(InputPath)"
