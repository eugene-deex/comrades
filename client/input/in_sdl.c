...
IN_Move(usercmd_t *cmd)
{
	...
	joyViewFactor = (1.0f/32768.0f) * (cls.rframetime/0.01666f);
...
IN_Haptic_Effects_To_Id(int haptic_effect, int effect_volume, int effect_x, int effect_y, int effect_z)
{
	...
	hapric_volume = joy_haptic_magnitude->value * effect_volume * 16; // * 128 = 32767 max strength;
...
IN_Haptic_Effects_Init(void)
{
	...
	for (i=0; i<HAPTIC_EFFECT_LAST; i++)
	{
